...
|-----------|--------------|
| <pre>furniture/<br>├── README.dataset.txt<br>├── README.roboflow.txt<br>├── furniture.v1i.tfrecord.zip<br>├── test<br>│   ├── game_label_map.pbtxt<br>│   └── game.tfrecord<br>├── train<br>│   ├── game_label_map.pbtxt<br>│   └── game.tfrecord<br>└── valid<br>    ├── game_label_map.pbtxt<br>    └── game.tfrecord</pre> | - **labels** = `['TV', 'bed', 'chair', 'couch', 'desk', 'nightstand']`<br>- **number of classes** = 6<br>- **training samples** = 1155<br>- **validation samples** = 326<br>- **test samples** = 168<br>- **size** = 155 MB (including zip file)<br>- **label formats** = **tfrecord (default)** and YOLOvN|
| ![](../../../../docs/images/sample_7.png) | ![](../../../../docs/images/sample_9.png) |
...
save_model_path = os.path.join('./pretrained_models', 'centernet_akidanet18_furniture_adapted_224.h5')
