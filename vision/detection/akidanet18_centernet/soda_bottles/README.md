...
|-----------|--------------|
| <pre>soda_bottles/<br>├── README.dataset.txt<br>├── README.roboflow.txt<br>├── soda bottles.v3-release-640.tfrecord.zip<br>├── test<br>│   ├── soda-bottles_label_map.pbtxt<br>│   └── soda-bottles.tfrecord<br>├── train<br>│   ├── soda-bottles_label_map.pbtxt<br>│   └── soda-bottles.tfrecord<br>└── valid<br>    ├── soda-bottles_label_map.pbtxt<br>    └── soda-bottles.tfrecord</pre> | - **labels** = `['coca-cola', 'fanta', 'sprite']`<br>- **number of classes** = 3<br>- **training samples** = 1547<br>- **validation samples** = 486<br>- **test samples** = 216<br>- **size** = 333 MB (including zip file)<br>- **label formats** = **tfrecord (default)** and YOLOvN|
| ![](../../../../docs/images/sample_0.png) | ![](../../../../docs/images/sample_6.png) |
...
save_model_path = os.path.join('./pretrained_models', 'centernet_akidanet18_soda_bottles_adapted_224.h5')
